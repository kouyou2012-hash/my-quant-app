...
# ============ 页面基础配置 ============
st.set_page_config(page_title="万能量化终端", page_icon="chart_with_upwards_trend", layout="wide")
...
with st.sidebar:
    ...
    code = st.text_input("代码 (例如 513100)", value="513100")
    ...
    selected_refs = st.multiselect("选择对比指数:", list(ref_options.keys()), default=["上证指数"])
    
    btn_fetch = st.button("生成分析图表", type="primary", use_container_width=True)
